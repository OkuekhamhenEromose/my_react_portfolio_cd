    ...
    >
      {project.map((item, index) => (
        ...
        >
          {/* Icon */}
          <motion.div
            className="mb-1 md:mb-2 flex justify-center text-gray-800 dark:text-gray-200 max-[375px]:mb-1"
          ...
          {/* Number */}
          <motion.h2
            className="h2 text-[#003366] dark:text-gray-200 mb-1 max-[375px]:text-lg"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ delay: 0.7 + index * 0.1 }}
            viewport={{ once: true }}
          >
            <CountUp enableScrollSpy duration={3} end={item.num} delay={0.5} />+
          </motion.h2>

          {/* Title */}
          <motion.h3
            className="h3 text-[#003366] dark:text-gray-300 max-[375px]:text-xs"
