    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 mt-20">
        ...
        <motion.div className="w-full lg:w-2/5 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <motion.p
            className="p mb-2 text-sm sm:text-base leading-relaxed"
            variants={fadeInLeft}
          >
          ...
          <motion.p
            className="p mb-4 text-sm sm:text-base leading-relaxed"
            variants={fadeInLeft}
          >
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Link to="/contact" className="btn px-4 py-2 text-sm sm:text-base">
              Hire Me
            </Link>
          </motion.div>
        </motion.div>
